          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 <?= 'NIM : '.ucwords($this->session->userdata('nim')).'<br>'?>
                 <?= date('d-m-Y')?>
                </p>
              </li>
              <!-- Menu Footer-->
            ...
            <li class="<?php if($global->menu==$menu->menu_nama){echo 'active';}?> treeview">
              ...
              <ul class="treeview-menu">
                <?php foreach($menu->submenu AS $submenu):?>
                   <li class="?php if($global->menu==$menu->menu_nama){echo 'active';}?>"><a href="<?= $submenu->menu_link?>"><i class="<?= $submenu->menu_ikon?>"></i> <?= ucwords($submenu->menu_nama)?></a></li>
                <?php endforeach;?>
              </ul>
            </li>            
          <?php else:?>
