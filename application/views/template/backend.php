...
<!--================================HEADER================================-->
  <header class="main-header">
    ...
    <a href="<?php echo site_url()?>" class="logo">
      ...
      <span class="logo-lg"><b>ADHIKARYA</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?= ucwords($this->session->userdata('user_nama'))?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 ...
                 <small>Terdaftar :<?= date('d-m-Y',strtotime($this->session->userdata('user_tersimpan')))?></small>
                </p>
    ...
    <section class="content">
      ...
      <?php
        if(file_exists(APPPATH.$global->view)){
          ...
          echo "halaman view tidak ditemukan atau belum dibuat";
        }
      ?>
    </section>
    <!-- /.content -->
