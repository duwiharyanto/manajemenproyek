<div id="view">
	<div class="row">
		...
		<div class="col-sm-2">
			...
			<div class="form-group">
				<label>&nbsp</label>
				<a  id="print" class="hidden btn btn-flat btn-block btn-warning" target="_blank" onclick="cetak()"><span class="fa fa-print"></span> Cetak</a>
			</div>
...
<script type="text/javascript">
    ...
    function caripekerjaan(){
     ...
     function cetak(){
    	url=$('#print').attr('url');
		window.open(url,'cetaklaporan','width=800,height=600')    	
    }   
</script>